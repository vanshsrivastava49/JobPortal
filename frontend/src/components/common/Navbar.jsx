  ...
  return (
    <>
      <style>{`
        ...
        .hb-line {
          width: 18px; height: 2px; background: #374151; border-radius: 2px;
          transition: all 0.25s cubic-bezier(0.16,1,0.3,1); transform-origin: center;
        }
        ...
        /* Drawer user info (when logged in) */
        .md-user-card {
        ...
        .md-section-title {
          ...
          color: #9ca3af; padding: 4px 8px; margin-bottom: 4px;
        }
        .md-nav-item {
          display: flex; align-items: center; gap: 12px; padding: 12px 10px;
          border-radius: 10px; cursor: pointer; transition: background 0.13s; user-select: none;
        ...
        /* Drawer auth buttons */
        .md-auth-section { padding: 12px 12px; display: flex; flex-direction: column; gap: 10px; }
        .md-auth-label {
          font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px;
          color: #9ca3af; padding: 0 8px; margin-bottom: 2px;
        }

        /* Roles list inside drawer */
        .md-roles-group {
        ...
        /* Toggle between login/signup in drawer */
        .md-auth-toggle {
          display: flex; border-radius: 10px; background: #f1f5f9;
          padding: 4px; gap: 3px; margin-bottom: 6px;
        }
        .md-auth-toggle-btn {
          flex: 1; padding: 8px; border: none; border-radius: 7px; cursor: pointer;
          font-size: 13px; font-weight: 600; transition: all 0.18s; font-family: inherit;
          background: transparent; color: #6b7280;
        }
        .md-auth-toggle-btn.active {
      ...
      <div className={`mobile-drawer${mobileMenuOpen ? " visible" : ""}`}>
        ...
        <div className="md-header">
          <Link to="/" className="md-logo" onClick={closeMobileMenu}>
            <div className="logo-brand md-logo-brand">
              <span className="logo-green">Green</span>
              <span className="logo-black">Jobs</span>
            </div>
          </Link>
        ...
        <div className="md-section">
          ...
          <Link to="/jobs" className="md-nav-item" onClick={closeMobileMenu}>
            ...
            <div className="md-nav-text">
              ...
              <div className="md-nav-desc">Browse all open positions</div>
            </div>
          ...
          {(!isAuthenticated || showCompanies) && (
            <Link to="/businesses" className="md-nav-item" onClick={closeMobileMenu}>
              ...
              <div className="md-nav-text">
                <div className="md-nav-label">Companies</div>
                <div className="md-nav-desc">Explore green businesses</div>
              </div>
              <svg className="md-nav-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </Link>
          )}
        ...
        {/* Authenticated: Profile + Dashboard + Logout */}
        {isAuthenticated ? (
          <div className="md-section">
            ...
            <div className="md-nav-item" onClick={() => { handleProfile(); }}>
              ...
              <div className="md-nav-text">
                <div className="md-nav-label">My Profile</div>
                <div className="md-nav-desc">View and edit your details</div>
              </div>
              <svg className="md-nav-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </div>
            ...
            <div className="md-nav-item" onClick={() => { closeMobileMenu(); navigate(dashboardRoute); }}>
              ...
              <div className="md-nav-text">
                <div className="md-nav-label">Dashboard</div>
                <div className="md-nav-desc">Go to your workspace</div>
              </div>
              <svg className="md-nav-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </div>
            ...
            <div className="md-nav-item danger" onClick={handleLogout}>
              ...
              <div className="md-nav-text">
                <div className="md-nav-label">Logout</div>
                <div className="md-nav-desc">Sign out of your account</div>
              </div>
            </div>
          </div>
        ) : (
          /* Guest: login/signup role selector */
          <div className="md-section">
            ...
            <div className="md-auth-toggle">
              <button
                className={`md-auth-toggle-btn${mobileAuthPanel !== "signup" ? " active" : ""}`}
                onClick={() => setMobileAuthPanel(mobileAuthPanel === "login" ? null : "login")}
              >Login</button>
              <button
                className={`md-auth-toggle-btn${mobileAuthPanel === "signup" ? " active" : ""}`}
                onClick={() => setMobileAuthPanel(mobileAuthPanel === "signup" ? null : "signup")}
              >Sign Up</button>
            </div>
            ...
            {(mobileAuthPanel === "login" || mobileAuthPanel === null) && (
              <div className="md-roles-group">
                <div className="md-roles-header">
                  <span>Sign in as</span>
                  <span className="md-roles-type-badge login">Login</span>
                </div>
                {roles.map((role) => (
                  <div key={role.key} className="md-role-item" onClick={() => handleRoleLogin(role.key)}>
                    ...
                    <div className="md-role-text">
                      <div className="md-role-label">{role.label}</div>
                      <div className="md-role-desc">{role.desc}</div>
                    </div>
            ...
            {mobileAuthPanel === "signup" && (
              <div className="md-roles-group">
                <div className="md-roles-header">
                  ...
                  <span className="md-roles-type-badge signup">Sign Up</span>
                </div>
                {roles.map((role) => (
