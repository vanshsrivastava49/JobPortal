    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .skill-dropdown-trigger.open {
          border-color: #10b981; color: #15803d; background: #f0fdf4;
          box-shadow: 0 0 0 3px rgba(16,185,129,0.08);
        }
        .skill-dropdown-trigger.has-value {
          border-color: #6ee7b7; background: #d1fae5; color: #065f46;
        }
        ...
        .skill-option.active .skill-option-count {
        ...
        .skill-clear-btn {
          ...
          font-family: 'Inter', sans-serif; padding: 3px 6px;
        ...
        .skill-active-tag {
          ...
          background: #d1fae5; border: 1px solid #6ee7b7; border-radius: 50px;
          font-size: 12px; font-weight: 700; color: #065f46;
          max-width: 180px; overflow: hidden;
        }
        .skill-active-tag span {
          overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
        }
        .skill-active-tag button {
          background: none; border: none; cursor: pointer;
          display: flex; align-items: center; color: #065f46;
          padding: 0; opacity: 0.7; transition: opacity 0.15s; flex-shrink: 0;
        }
        ...
        .company-verified {
          display: flex; align-items: center; gap: 4px;
          font-size: 12px; color: #10b981; margin-top: 2px;
        }
        .job-meta {
          display: flex; gap: 10px; font-size: 13px; color: #64748b;
        ...
        .job-actions {
          display: flex; gap: 10px; padding-top: 14px; margin-top: auto;
        }
        .btn-view {
          flex: 1;
